...
class AdminStaff{
    ...
    init() {
       ...
       /*        ADMINISTRATION        */
        ...
        CreateStaffMember(name: "Anna Scharfeld", email: "ascharfeld@sbunified.org", title: "Assistant Principal 9th Grade", education: ["high school", "college", "college"], image: UIImage(named: "unknown")!, ext: "5003")
